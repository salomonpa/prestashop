...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
	{
		...
		$this->displayName = $this->l('YourBestCode theme configuration');
    ...
    private function _installDb()
    {
        ...
        {
            $YBC_TC_COPYRIGHT_TEXTS[$l['id_lang']] = $this->l('Copyright 2015 Your company. Designed by ').'<a target="_blank" class="_blank" href="http://www.yourbestcode.com">YourBestCode.com</a>';
        }        
    ...
    public function renderConfigForm()
    {
        $fields_form = array(
			'form' => array(
				'legend' => array(
					'title' => $this->l('YourBestCode theme configuration'),
    ...
    {   
        Tools::addJs($this->_path.'js/ybctab.js');
        Tools::addCSS($this->_path.'css/skins.css', 'all');
        Tools::addCSS($this->_path.'css/font-awesome.css', 'all');
        Tools::addCSS($this->_path.'css/owl/owl.carousel.css', 'all');
        Tools::addCSS($this->_path.'css/owl/owl.theme.css', 'all');
        Tools::addCSS($this->_path.'css/owl/owl.transitions.css', 'all');
        Tools::addJS($this->_path.'js/owl.carousel.js');
        if(Configuration::get('YBC_TC_SHOW_SETTING'))
        {
            ...
            Tools::addCSS($this->_path.'css/themeconfig.css', 'all');
        }
