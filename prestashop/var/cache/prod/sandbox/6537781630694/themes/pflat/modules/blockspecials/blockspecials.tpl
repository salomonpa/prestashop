...
<div id="special_block_right" class="block">
	<p class="title_block">
        <a href="{$link->getPageLink('prices-drop')|escape:'html':'UTF-8'}" title="{l s='Specials' mod='blockspecials'}">
            {l s='Special products' mod='blockspecials'}
        </a>
    </p>
    ...
    {if $special}
		...
		<div>
			<a class="view_all_product" href="{$link->getPageLink('prices-drop')|escape:'html':'UTF-8'}" title="{l s='All specials' mod='blockspecials'}">
                <span>{l s='View all special products' mod='blockspecials'}<i class="fa fa-angle-double-right right"></i></span>
            </a>
		</div>
    {else}
