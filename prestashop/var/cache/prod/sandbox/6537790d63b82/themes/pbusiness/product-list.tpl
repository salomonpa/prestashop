...
{if isset($products) && $products}
	...
	{foreach from=$products item=product name=products}
		...
		<li class="ajax_block_product{if $page_name == 'index' || $page_name == 'product' || $page_name == 'category' || $page_name == 'prices-drop' || $page_name == 'search' || $page_name == 'best-sales'} col-xs-12 col-sm-4 col-md-3{else} col-xs-12 col-sm-4 col-md-3{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLine == 0} last-in-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLine == 1} first-in-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulo)} last-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 0} last-item-of-tablet-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 1} first-item-of-tablet-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 0} last-item-of-mobile-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 1} first-item-of-mobile-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModuloMobile)} last-mobile-line{/if}">
			<div class="product-container {if $page_name == 'index'}no-compare{/if}" itemscope itemtype="http://schema.org/Product">
				<div class="left-block">
					<div class="product-image-container">
						...
						<a title="{l s='Quick view'}" class="quick-view" href="{$product.link|escape:'html':'UTF-8'}" {*rel="{$product.link|escape:'html':'UTF-8'}"*}>
				...
				<div class="right-block">
					...
					{/if}
                    *}
                    {if $page_name != 'index' || true}
    	 				<div class="functional-buttons clearfix">
    						{hook h='displayProductListFunctionalButtons' product=$product}
    						{if isset($comparator_max_item) && $comparator_max_item && $page_name != 'index'}
    							<div class="compare">
    								<a class="add_to_compare" title="{l s='Add to Compare'}" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product}">&nbsp;</a>
    							</div>
    						{/if}
    					</div>
    				{/if}
