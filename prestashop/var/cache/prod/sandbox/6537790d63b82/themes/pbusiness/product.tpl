	...
	<div class="primary_block row">
		...
		<div class="pb-left-column col-xs-12 col-sm-4 col-md-6">
            {if isset($images) && count($images) > 0}
				...
				<div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if}">
					...
					{*if isset($images) && count($images) > 2}
						<span class="view_scroll_spacer"><a id="view_scroll_right" title="{l s='Other views'}" href="javascript:{ldelim}{rdelim}">
							{l s='Next'}
						  </a>
                        </span>
					{/if*}
			...
			{if isset($images) && count($images) > 1}
				<p class="resetimg clear no-print">
					<span id="wrapResetImages" style="display: none;">
						<a href="{$link->getProductLink($product)|escape:'html':'UTF-8'}" {*fix-sang name="resetImages"*}>
		...
		<div class="pb-center-column col-xs-12 col-sm-4">			
            ...
            {if isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT}
        		<!-- pb-right-column-->        
            		<div class="ybc-extra-right-moved">                        
            			{$HOOK_EXTRA_RIGHT}
            		</div> 
                <!-- end pb-right-column-->
            {/if}
													...
													<ul id="color_to_pick_list" class="clearfix">
														...
														{foreach from=$group.attributes key=id_attribute item=group_attribute}
															...
															<li{if $group.default == $id_attribute} class="selected"{/if}>
																<a href="{$link->getProductLink($product)|escape:'html':'UTF-8'}" id="color_{$id_attribute|intval}" {*sang  name="{$colors.$id_attribute.name|escape:'html':'UTF-8'}"*} class="color_pick{if ($group.default == $id_attribute)} selected{/if}"{if !$img_color_exists && isset($colors.$id_attribute.value) && $colors.$id_attribute.value} style="background:{$colors.$id_attribute.value|escape:'html':'UTF-8'};"{/if} title="{$colors.$id_attribute.name|escape:'html':'UTF-8'}">
																	{if $img_color_exists}
		...
		<!-- end center infos-->
        <!-- Hook YourBestCode Product HTML -->
        {hook h='displayYbcProductHtml'}       
        <!-- /Hook YourBestCode Product HTML --> 
	</div> <!-- end primary_block -->
    
	{if !$content_only}
        <div id="tabs" class="tabs-product-content">
          <ul class="title_tab_product">
            {if $product->description}<li><a href="#idTab1">{l s='More info'}</a></li>{/if}
            {if isset($features) && $features}<li><a href="#idTab2">{l s='Data sheet'}</a></li>{/if}
            {if isset($accessories) && $accessories}<li><a href="#idTab3">{l s='Accessories'}</a></li>{/if}
            {$HOOK_PRODUCT_TAB}
        ...
        {if $product->description}
			<!-- More info -->
             <button id="decription-toggle" class="button_toggle_content_tab" >More info</button>
			<section id="idTab1" class="page-product-box">
               <h3 class="page-product-heading" style="display:none!important;">&nbsp;</h3>
                <div id="decription-content">
        ...
        {if isset($features) && $features}
			<!-- Data sheet -->
            <button id="features-toggle" class="button_toggle_content_tab" >Data sheet</button>
			<section id="idTab2" class="page-product-box">
                <h3 class="page-product-heading" style="display: none!important">{l s='Data sheet'}</h3>
        ...
        {if isset($accessories) && $accessories}
			<!--Accessories -->
            <button id="accessories-toggle" class="button_toggle_content_tab" >Accessories</button>
										...
										<div class="s_title_block">
											<h5 class="product-name">
												<a href="{$accessoryLink|escape:'html':'UTF-8'}">
													{$accessory.name|truncate:22:'...':true|escape:'html':'UTF-8'}
												</a>
											</h5>
        ...
        {if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
			<!-- quantity discount -->
             <button id="volume-discounts-toggle" class="button_toggle_content_tab" >Volume discounts</button>
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<section id="idTab6" class="page-product-box">
                <button id="download-toggle">Download</button>
				{*<h3 class="page-product-heading">{l s='Download'}</h3>*}
                <div id="dowload-content">
...
$(document).ready(function(){
    ...
    $("#decription-toggle").click(function(){
        $("#idTab1").toggle();
    });
    $("#volume-discounts-toggle").click(function(){
        $("#idTab4").toggle();
    });
    ...
    $("#accessories-toggle").click(function(){
        $("#idTab3").toggle();
    });
