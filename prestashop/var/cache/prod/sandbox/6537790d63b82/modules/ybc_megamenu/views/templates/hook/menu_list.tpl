    				...
    				<li class="ybc-menu-item" rel="{$menu.id_menu}" id="menu_{$menu.id_menu}">	
                        	...
                        	<div class="ybc-mm-level1 ybc-mm-item">			
                                ...
                                <div class="ybc-mm-toolbox">
                                    <a onclick="return confirm('{l s='When you delete this menu, all columns/blocks inside this menu will be deleted. Do you confirm?'}');" style="text-decoration: none!important; margin-right: 10px;" href="{$admin_path}&id_menu={$menu.id_menu}&control=menu&configure=ybc_megamenu&delmenu=true">
                                    ...
                                    {foreach from=$menu.columns item=column}
                        				<li class="ybc-column-item" rel="{$column.id_column}" id="column_{$column.id_column}" >
                                            ...
                                            <div class="ybc-level2 ybc-mm-item">					
                                                ...
                                                <div class="ybc-mm-toolbox">
                                                    <a onclick="return confirm('{l s='When you delete this column, all blocks inside this column will be deleted. Do you confirm?'}');" style="text-decoration: none!important; margin-right: 10px;" href="{$admin_path}&id_column={$column.id_column}&control=column&configure=ybc_megamenu&delcolumn=true">
                                        				...
                                        				<li class="ybc-block-item" rel="{$block.id_block}" id="block_{$block.id_block}" >
                                                            <!-- Level 3 -->
                                                                <div class="ybc-level3 ybc-mm-item">					
                                                                    ...
                                                                    <div class="ybc-mm-toolbox">
                                                                        <a onclick="return confirm('{l s='This block will be deleted. Do you confirm?'}');" style="text-decoration: none!important;" href="{$admin_path}&id_block={$block.id_block}&control=block&configure=ybc_megamenu&delblock=true">
