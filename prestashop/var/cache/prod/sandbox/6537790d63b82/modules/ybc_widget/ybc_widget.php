...

{
...

	{
		...
		$this->displayName = $this->l('YBC widgets');
        ...
        $this->_hooks = array(
            ...
            array(
                ...
                'name' => $this->l('Hook Left Column Product')
            ...
            array(
                ...
                'name' => $this->l('Hook Right Column Product')
            ...
            array(
                ...
                'name' => $this->l('Hook Store opening time')
            ...
            array(
                ...
                'name' => $this->l('Hook Footer payment logo')
...

    {
        ...
        $widgets = array(
            ...
            array(
                ...
                'title' => $this->l('Free shipping and return'),
            ...
            array(
                ...
                'title' => $this->l('Free support 24/7'),
            ...
            array(
                ...
                'title' => $this->l('Money back guarantee'),
            ...
            array(
                ...
                'title' => $this->l('STORE OPENING TIME:'),

                'hook' => 'ybcCustomHook',

                'description' => '<p>Mon-Fri: ................. 7.00 to 16.00<br /> Sat: .......................... 8.00 to 20.00<br /> Sun: ......................... 6.00 to 19.00</p>',                               

            ),

            array(

                'title' => $this->l('Payment logos'),

                'hook' => 'ybcPaymentLogo',               

                'image' => 'paymentlogos.png',
            ...
            array(
                ...
                'title' => $this->l('Footer links'),

                'hook' => 'ybcFooterLinks',

                'show_title' => 0,   

                'description' => '<ul><li><a href="#">Sitemap</a></li><li><a href="#">Privacy</a></li><li><a href="#">Store location</a></li><li><a href="#">Contact us</a></li></ul>'             
...

        {
            ...
            $widget->show_title = isset($data['show_title']) && $data['show_title'] || !isset($data['show_title']) ? 1 : 0;

            $widget->show_description = 1;

            $widget->link = '';

            $widget->image = isset($data['image']) && $data['image'] ? $data['image'] : '';

            $widget->sort_order = $ik;

            $widget->hook = $data['hook'];

            foreach($languages as $lang)

            {

                $widget->title[$lang['id_lang']] = $data['title'];

                $widget->description[$lang['id_lang']] = isset($data['description']) && $data['description'] ? $data['description'] : '';
...

            {
                ...
                if(file_exists(dirname(__FILE__).'/images/sample/'.$data['image']) && !file_exists(dirname(__FILE__).'/images/widget/'.$data['image']))

                {

                    @copy(dirname(__FILE__).'/images/sample/'.$data['image'], dirname(__FILE__).'/images/widget/'.$data['image']);
    ...
    {        
            ...
            $helper->tpl_vars = array(
    			...
    			'fields_value' => $this->getFieldsValues($this->widgetFields,'id_widget','Ybc_widget_widget_class','saveWidget'),
    ...
    {    
...

        {
            ...
            $this->_html .= '<div class="widget_hook" rel="'.$hook['hook'].'"><div class="widget_heading widget_'.strtolower($hook['hook']).'">'.$hook['name'].' <a title="'.$this->l('Add a widget to this hook').'" href="'.$this->baseAdminPath.'&control=widget&hook='.$hook['hook'].'"><i class="process-icon-new"></i></a></div>';                      
...

    {
        ...
        $sql = "SELECT w.*, wl.title, wl.description 
                ...
                WHERE w.hook = '$hook' ".($enabled ? ' AND enabled=1 ' : '')."
