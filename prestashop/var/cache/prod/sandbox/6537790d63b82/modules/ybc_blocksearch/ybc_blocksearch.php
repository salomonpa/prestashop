...
class Ybc_blockSearch extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('YBC search block');
	...
	{
		if (!parent::install() || !$this->_installDb() || !$this->registerHook('top') || !$this->registerHook('header') || !$this->registerHook('displayMobileTopSiteMap'))
			return false;
		return true;
	} 
