...
<section id="product_comments_block_extra" class="no-print" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
	{if $nbComments != 0}
...
$(function(){
	$('a[href=#idTab5]').click(function(){
		...
		$('ul.title_tab_product a[href^="#idTab"]').removeClass('selected');
