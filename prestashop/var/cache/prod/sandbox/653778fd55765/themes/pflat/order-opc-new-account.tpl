<div id="opc_new_account" class="opc-main-block">
	...
	<h1 class="page-heading step-num"><span class="number-step">1</span> <span class="title_cat">{l s='Account'}</span></h1>
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
		<fieldset>
			<h3 class="page-subheading"><span class="title_cat">{l s='Already registered?'}</span></h3>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
        	<div class="box">
                <h3 id="new_account_title" class="page-subheading"><span class="title_cat">{l s='New Customer'}</span></h3>
				...
				{/if}
				<h3 class="page-subheading top-indent"><span class="title_cat">{l s='Delivery address'}</span></h3>
				{$stateExist = false}
				{$postCodeExist = false}
				{$dniExist = false}
