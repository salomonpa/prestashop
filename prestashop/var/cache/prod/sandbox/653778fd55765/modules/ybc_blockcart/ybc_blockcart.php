...
class Ybc_BlockCart extends Module
{
	public function __construct()
	{
		$this->name = 'ybc_blockcart';
		...
		$this->displayName = $this->l('YourBestCode Cart block');
		$this->description = $this->l('Adds a block containing the customer\'s shopping cart. This module is modified by YourBestCode.com to fit our themes');
	...
	public function install()
	{
		if (
            ...
            || $this->registerHook('DisplayNav') == false
