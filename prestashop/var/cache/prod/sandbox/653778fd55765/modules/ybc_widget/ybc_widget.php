...
class Ybc_widget extends Module
{
	...
	{	   
		...
		$this->displayName = $this->l('YBC HTML widgets');
		$this->description = $this->l('Add custom html widgets to specific postions on frontend');
        ...
        $this->_hooks = array(
            ...
            array(
                'hook' => 'ybcCustom1',
                'name' => $this->l('Big banner in home')
            ),
            array(
                'hook' => 'ybcCustom2',
                'name' => $this->l('Tesimonials in home page')
            ),
            
            array(
                'hook' => 'ybcCustom5',
                'name' => $this->l('Footer middle')
            ),
            array(
                'hook' => 'ybcCustom6',
                'name' => $this->l('Banner inside slider (home layout 4)')
            ),
    ...
    public function getContent()
	{
       ...
       return $this->_html.'</div>'.$this->displayIframe();
    }
    ...
    { 
        $this->context->controller->addCSS((__PS_BASE_URI__).'modules/'.$this->name.'/views/css/widget.css', 'all');        
    }
    ...
    private function installSample()
     {       
       ...
       if($oldFiles = glob(dirname(__FILE__).'/images/widget/*'))
        ...
        $this->copyDir(dirname(__FILE__).'/views/img/',dirname(__FILE__).'/images/widget/');
    }
