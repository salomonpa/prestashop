						...
						<div class="col-md-8">
							...
							<div class="btn-group-action pull-right">
								...
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=ybc_nivoslider&id_slide={$slide.id_slide|escape:'html':'UTF-8'}">
									<i class="icon-edit"></i>
									{l s='Edit' mod='ybc_nivoslider'}
								</a>
								<a onclick="return confirm('{l s='Do you want to delete this slide?'}')" class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=ybc_nivoslider&delete_id_slide={$slide.id_slide|escape:'html':'UTF-8'}">
