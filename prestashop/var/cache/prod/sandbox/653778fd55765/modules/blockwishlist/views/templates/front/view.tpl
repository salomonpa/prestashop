...
<p>
	...
	{foreach from=$wishlists item=wishlist name=i}
		{if $wishlist.id_wishlist != $current_wishlist.id_wishlist}
			<a href="{$link->getModuleLink('blockwishlist', 'view', ['token' => $wishlist.token])|escape:'html':'UTF-8'}" title="{$wishlist.name|escape:'html':'UTF-8'}" rel="nofollow">{$wishlist.name|escape:'html':'UTF-8'}</a>
            ...
            <li id="wlp_{$product.id_product|escape:'html':'UTF-8'}_{$product.id_product_attribute|escape:'html':'UTF-8'}" class="clearfix address {if $smarty.foreach.i.index % 2}alternate_{/if}item">
                ...
                <div class="btn_action">
                    ...
                    {if (isset($product.attribute_quantity) && $product.attribute_quantity >= 1) || (!isset($product.attribute_quantity) && $product.product_quantity >= 1) || $product.allow_oosp}
                        ...
                        {/if}
                        <a href="javascript:;" class="exclusive" onclick="WishlistBuyProduct('{$token|escape:'html':'UTF-8'}', '{$product.id_product|escape:'html':'UTF-8'}', '{$product.id_product_attribute|escape:'html':'UTF-8'}', '{$product.id_product|escape:'html':'UTF-8'}_{$product.id_product_attribute|escape:'html':'UTF-8'}', this, {$ajax|escape:'html':'UTF-8'});" title="{l s='Add to cart' mod='blockwishlist'}" rel="nofollow">{l s='Add to cart' mod='blockwishlist'}</a>
                    {else}
