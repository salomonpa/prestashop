...
//        die('ok');
		...
		$this->displayName = $this->l('YourBestCode Rich Mega Menu');
    ...
    private function _postMenu()
    {
        ...
        {            
            ...
            $menu->id_category = trim(Tools::getValue('id_category',0));
    ...
    {        
        Tools::addCSS((__PS_BASE_URI__).'modules/'.$this->name.'/css/admin.css', 'all');        
    }
