...
class Ybc_SocialSharing extends Module
{
	...
	{
		$this->name = 'ybc_socialsharing';
		$this->author = 'YourBestCode.com';
		$this->tab = 'advertising_marketing';
		$this->need_instance = 0;
		$this->version = '1.2.9.0';
		$this->bootstrap = true;
		$this->_directory = dirname(__FILE__);

		parent::__construct();

		$this->displayName = $this->l('YourBestCode.com Social sharing');
		$this->description = $this->l('Displays social sharing buttons (Twitter, Facebook, Google+ and Pinterest) on every product page. Modified by YourBestCode.com to fit our themes');
	}
