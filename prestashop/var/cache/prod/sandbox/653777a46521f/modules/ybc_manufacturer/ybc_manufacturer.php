...

{
...

	{
		...
		$this->displayName = $this->l('YBC manufacturers/brands block');
     ...
     */
...

     {
...

		{
            ...
            if(file_exists(_PS_MANU_IMG_DIR_.$manufacturer['id_manufacturer'].'.jpg'))
                ...
                $manufacturer['image'] = $this->_path.'views/img/default_logo.jpg';
...

     {
        ...
        $this->context->controller->addCSS($this->_path.'views/css/ybcmnf.css','all');

        $this->context->controller->addJS($this->_path.'views/js/ybcmnf.js');   
