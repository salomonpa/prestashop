$(document).ready(function(){
    ...
    if($('.ybc_block_type').length > 0)
    {
        ...
        {
            $('.ybc-right-panel .form-wrapper').children('.form-group').eq(3).addClass('ybc_block_CATEGORY');
            $('.ybc-right-panel .form-wrapper').children('.form-group').eq(4).addClass('ybc_block_CATEGORY');        
            $('.ybc-right-panel .form-wrapper').children('.form-group').eq(5).addClass('ybc_block_MNFT');
            $('.ybc-right-panel .form-wrapper').children('.form-group').eq(6).addClass('ybc_block_CMS');
            $('.ybc-right-panel .form-wrapper').children('.form-group').eq(7).addClass('ybc_block_PRODUCT');
            $('.ybc-right-panel .form-wrapper').children('.form-group').eq(8).addClass('ybc_block_HTML');
            $('.ybc-right-panel .form-wrapper').children('.form-group').eq(9).addClass('ybc_block_CUSTOM');
        ...
        {
            $('.ybc-right-panel .panel').children('.form-group').eq(3).addClass('ybc_block_CATEGORY');
            $('.ybc-right-panel .panel').children('.form-group').eq(4).addClass('ybc_block_CATEGORY');        
            $('.ybc-right-panel .panel').children('.form-group').eq(5).addClass('ybc_block_MNFT');
            $('.ybc-right-panel .panel').children('.form-group').eq(6).addClass('ybc_block_CMS');
            $('.ybc-right-panel .panel').children('.form-group').eq(7).addClass('ybc_block_PRODUCT');
            $('.ybc-right-panel .panel').children('.form-group').eq(8).addClass('ybc_block_HTML');
            $('.ybc-right-panel .panel').children('.form-group').eq(9).addClass('ybc_block_CUSTOM');
