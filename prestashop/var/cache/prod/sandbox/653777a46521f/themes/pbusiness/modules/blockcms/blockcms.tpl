...
{else}
	...
	{*if $display_poweredby}
    	<section class="bottom-footer col-xs-12">
            <h6 class="add_copyright" style="display:none;">coppyright</h6>
            <div class="container">
        		<div>
        			{l s='[1]Coppyright 2015 Pbusiness Demo. All rights resevered[/1]' mod='blockcms' sprintf=[''] tags=['<a class="_blank" href="http://www.yourbestcode.com">']}
        		</div>
            </div>
    	</section>
	{/if*}
