...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
        ...
        {elseif (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT4')}
            <link rel="stylesheet" href="{$css_dir}/layout_4.css" type="text/css" media="all" />
        {else}
            <link rel="stylesheet" href="{$css_dir}/layout_1.css" type="text/css" media="all" />
        {/if}
	...
	{if !isset($content_only) || !$content_only}
		...
		<div id="page">
            ...
            {elseif isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT4'}
                {include file="$tpl_dir./sub/header/layout_4.tpl"}
            {else}
    						...
    						<div class="container">
    							<div class="row">
                                    {if isset($tc_config.YBC_TC_FLOAT_HEADER) && $tc_config.YBC_TC_FLOAT_HEADER}
                                        <div class="ybc_custom_float_header a">
                                            <div class="container">
                                                <div class="row">
                                    {/if}
        								<div id="header_logo">
