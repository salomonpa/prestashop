...
<!-- Block Newsletter module-->
    ...
    <section id="newsletter_block_left" class="footer-block col-xs-12 {if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT2')}col-md-4 col-sm-4{/if} ">
        <div class="{if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT != 'LAYOUT2')}container{/if} ">	
       <div class="box-newletter {if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT != 'LAYOUT2')}col-sm-6 col-md-6{/if} ">	 
        <h4 class="">{l s='Newsletter' mod='blocknewsletter'}</h4>
        <div class="block_content toggle-footer">
            <p>{l s='Subcribe to our mailing list to get updated on our special offers and news' mod='blocknewsletter'}</p>
