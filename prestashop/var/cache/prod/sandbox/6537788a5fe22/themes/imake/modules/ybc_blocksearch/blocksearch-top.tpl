...
<div id="search_block_top" class="{if $tc_config.YBC_TC_LAYOUT == 'LAYOUT2'}search_layout_2{elseif $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'} search_layout_3{else} search_layout_1{/if} {if $searched_categories}has-categories-dropdown{else}no-categories-dropdown{/if}">
