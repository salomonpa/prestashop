	...
	{if isset($fieldset['form']['submit']) || isset($fieldset['form']['buttons'])}
		<div class="panel-footer">
            {if isset($reset_url) && $reset_url}
                <a title="{l s='Reset to default parameters'}" onclick="return confirm('{l s='You are going to reset all parameters to default. Do you confirm?' mod='ybc_themeconfig'}');" class="btn btn-default" href="{$reset_url|escape:'html':'UTF-8'}"><i class="process-icon-refresh"></i>Reset</a>
            {/if}
